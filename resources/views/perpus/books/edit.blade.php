    ...
    <div class="grid-padding text-left col-md-8 mx-auto">
        <form action="{{ route('perpusku.book.edit', $book) }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control mb-4" placeholder="Pengaran" name="pengarang"
            ...
            <div class="form-group">
                ...
                <input type="number" class="form-control mb-4" placeholder="tahun terbit contoh 2020" name="tahun_terbit"
            ...
            <div class="form-group">
                ...
                <input type="number" class="form-control mb-4" placeholder="Stok Buku" name="stok"
            ...
            <div class="form-group">
                ...
                <select name="jenis_buku" id="jenis_buku" class="form-control mb-4">
                    ...
                    @foreach (App\Models\Book::JENIS as $jenis)
                        <option value="{{ $jenis }}" {{ $book->jenis_buku == $jenis ? 'selected' : '' }}>
                            {{ $jenis }}</option>
                    @endforeach
                </select>
                @error('jenis_buku')
            ...
            <div class="form-group p-5">
                ...
                <br>
                <img src="{{ Storage::url($book->photo) }}" class="img rounded p-4  " height="150px" width="150px"
                    alt="photo {$book->name}">
                <button class="btn btn-primary " style="cursor: default;">Mau ganti gambar ? isi kembali</button>
            ...
            <div class="form-group">
                <button type="submit" class="btn btn-sm btn-primary  mt-3">Ubah data Buku</button>
            </div>
        </form>
    </div>
@endsection
