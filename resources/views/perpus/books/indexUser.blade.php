    ...
    <div class="grid-padding text-center">
        ...
        @foreach ($books as $book)
            <div class="card col-md-4 d-inline-block m-3">
                <div class="card-body">
                    <div class="card-img">
                        <img src="{{ Storage::url($book->photo) }}" class="img img-rounded-pill" width="100px" height="100px"
                            alt="">
                    </div>
                ...
                <div class="card-footer">
                    <form action="{{ route('perpusku.borrow.index') }}" method="POST">
                        ...
                        <input type="hidden" class="form-control mb-4" placeholder="tanggal_kembali" name="tanggal_kembali"
                        ...
                        @elseif (in_array(auth()->id(), App\Models\Borrow::pluck('user_id')->toArray()) &&
                                in_array($book->id, App\Models\Borrow::pluck('book_id')->toArray()) &&
                                $book->borrow->status == 'pinjam')
