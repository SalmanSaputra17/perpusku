                    ...
                    <form action="{{ route('perpusku.borrow.index') }}" method="POST" enctype="multipart/form-data">
                        ...
                        @if (auth()->user()->role == 'member')
                            <div class="form-group">
                                ...
                                <input type="hidden" class="form-control mb-4" placeholder="nama peminjam" name="user_id"
                        ...
                        <div class="form-group">
                            ...
                            <div class="alert alert-dark rounded">
                                {{ date('d M Y', strtotime(Carbon\Carbon::today()->toDateString())) }}</div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="alert alert-success rounded">
                                {{ date('d M Y',strtotime(Carbon\Carbon::today()->addDays(7)->toDateString())) }}</div>
